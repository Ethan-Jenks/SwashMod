...
public class MomentumPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = SwashMod.makeID("MomentumPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("momentum_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("momentum_power32.png"));
        ...
        if(card.type.equals(AbstractCard.CardType.SKILL)) {
            if(amount > 0) {
                AbstractDungeon.actionManager.addToBottom(
                        new GainBlockAction(this.owner, this.owner, amount));
            }
            AbstractDungeon.actionManager.addToBottom(
